...
public class Cellular_Data_Service extends Service {
    ...
    private String fileCorruptionInfo="The file MobileDataDisabled.txt did not exist! Service has enabled cell data and set the state to false! ";
